...
func TestAPI_Operation(t *testing.T) {
	...
	t.Run("invalid response body", func(t *testing.T) {
		_, err := New(server.URL).Operation("AX1234BT")
...
func TestAPI_Operations(t *testing.T) {
	...
	t.Run("invalid response body", func(t *testing.T) {
		_, err := New(okServer.URL).Operations("AX1234BT", 1)
		if err.Error() != "invalid response body" {
			t.Fail()
		}
	})
...
func TestAPI_OperationsWithFixture(t *testing.T) {
	...
	operations, err := New(server.URL).Operations("АА9359РС", 1)
	if err != nil {
		t.Fail()
	}
...
func TestAPI_Registrations(t *testing.T) {
	...
	t.Run("invalid response body", func(t *testing.T) {
		_, err := New(server.URL).Registrations("CXI012345")
		if err.Error() != "invalid response body" {
			t.Fail()
		}
	})
...
func TestAPI_RegistrationsWithFixture(t *testing.T) {
	...
	registrations, err := New(server.URL).Registrations("СХН484154")
	if err != nil {
		t.Fail()
	}
